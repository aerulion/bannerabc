		...
		try {
			...
			if (args.length == 2) {
				if (args[0].equalsIgnoreCase("add")) {
					if (!(p.hasPermission("bannerabc.addcategory"))) {
						p.sendMessage("§8[§a§l§oBannerABC§8] §cFehler: Du hast nicht die erforderlichen Rechte!");
						return true;
					}
					if (Utils.categories.size() >= 54) {
						sender.sendMessage("§8[§a§l§oBannerABC§8] §cFehler: Du hast die maximale Anzahl an Kategorien erstellt!");
						return true;
					}
					if (p.getInventory().getItemInMainHand().getType().equals(Material.AIR)) {
						sender.sendMessage("§8[§a§l§oBannerABC§8] §cFehler: Du musst ein Item in der Hand halten!");
						return true;
					}
					if (FileManager.CategoryExists(args[1].replaceAll("#", " "), false)) {
						sender.sendMessage("§8[§a§l§oBannerABC§8] §cFehler: Es existiert bereits eine Kategorie mit diesem Namen!");
						return true;
					}
					ItemStack DisplayItem = p.getInventory().getItemInMainHand();
					FileManager.addCategory(args[1].replaceAll("#", " "), DisplayItem);
					sender.sendMessage("§8[§a§l§oBannerABC§8] §7Folgende Kategorie wurde hinzugefügt: §a§l" + args[1].replaceAll("#", " "));
					return true;
				}
				...
				if (args[0].equalsIgnoreCase("remove")) {
					...
					if (FileManager.CategoryExists(args[1].replaceAll("#", " "), true)) {
						if (args[1].replaceAll("#", " ").equals("Unsortiert")) {
							sender.sendMessage("§8[§a§l§oBannerABC§8] §cFehler: Die Standart Kategorie kann nicht entfernt werden!");
							return true;
						}
						FileManager.removeCategory(args[1].replaceAll("#", " "));
						sender.sendMessage("§8[§a§l§oBannerABC§8] §7Folgende Kategorie wurde entfernt: §a§l" + args[1].replaceAll("#", " "));
						return true;
					}
					sender.sendMessage("§8[§a§l§oBannerABC§8] §cEs wurde keine Kategorie mit diesem Namen gefunden!");
					return true;
				}
				...
				if (args[0].equalsIgnoreCase("setitem")) {
					...
					FileManager.setCatItem(args[1].replaceAll("#", " "), p.getInventory().getItemInMainHand());
					return true;
				}
			...
			if (args.length == 3) {
				if (args[0].equalsIgnoreCase("set")) {
					...
					sender.sendMessage("§8[§a§l§oBannerABC§8] §7Das Banner §a§l" + args[1].replaceAll("#", " ") + "§7 ist jetzt in der Kategorie §a§l" + args[2].replaceAll("#", " ") + "§7.");
				...
				if (args[0].equalsIgnoreCase("rename")) {
					...
					sender.sendMessage("§8[§a§l§oBannerABC§8] §7Die Kategorie §a§l" + args[1].replaceAll("#", " ") + "§7 heißt jetzt §a§l" + args[2].replaceAll("#", " ") + "§7.");
