...
public class LetterMenu extends Menu {
	...
	public LetterMenu(String name, int size) {
		super(name, size);
	}
	...
	public void registerItems() {
		...
		ItemStack c1 = new ItemStack(Material.INK_SAC);
		ItemMeta c1m = c1.getItemMeta();
		c1m.setDisplayName("§7§l§oSchwarz");
		c1.setItemMeta(c1m);
		inv.addItem(c1);
		ItemStack c2 = new ItemStack(Material.ROSE_RED);
		ItemMeta c2m = c2.getItemMeta();
		c2m.setDisplayName("§7§l§oRot");
		c2.setItemMeta(c2m);
		inv.addItem(c2);
		ItemStack c3 = new ItemStack(Material.CACTUS_GREEN);
		ItemMeta c3m = c3.getItemMeta();
		c3m.setDisplayName("§7§l§oGrün");
		c3.setItemMeta(c3m);
		inv.addItem(c3);
		ItemStack c4 = new ItemStack(Material.COCOA_BEANS);
		ItemMeta c4m = c4.getItemMeta();
		c4m.setDisplayName("§7§l§oBraun");
		c4.setItemMeta(c4m);
		inv.addItem(c4);
		ItemStack c5 = new ItemStack(Material.LAPIS_LAZULI);
		...
		inv.addItem(c11);
		ItemStack c12 = new ItemStack(Material.DANDELION_YELLOW);
		...
		inv.addItem(c15);
		ItemStack c16 = new ItemStack(Material.BONE_MEAL);
		...
		if (item.hasItemMeta()) {
			if (item.getItemMeta().hasDisplayName()) {
				...
				if (m.equals("§7§l§oSchwarz")) {
					...
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oRot")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.RED);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oGrün")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.GREEN);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oBraun")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.BROWN);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oBlau")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.BLUE);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oViolett")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.PURPLE);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oTürkis")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.CYAN);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oHellgrau")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.LIGHT_GRAY);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oGrau")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.GRAY);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oRosa")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.PINK);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oHellgrün")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.LIME);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oGelb")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.YELLOW);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oHellblau")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.LIGHT_BLUE);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oMagenta")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.MAGENTA);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oOrange")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.ORANGE);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
				if (m.equals("§7§l§oWeiß")) {
					Utils.lettercolors.put(p.getUniqueId(), DyeColor.WHITE);
					p.openInventory(Utils.AlphabetInv(Utils.lettercolors.get(p.getUniqueId()), Utils.backgroundcolors.get(p.getUniqueId())));
				}
