...
public class Utils {
	...
	public final static List<Material> BannerItems = Arrays.asList(Material.BLACK_BANNER, Material.BLUE_BANNER, Material.BROWN_BANNER, Material.CYAN_BANNER, Material.GREEN_BANNER, Material.GRAY_BANNER, Material.LIGHT_BLUE_BANNER, Material.LIGHT_GRAY_BANNER, Material.LIME_BANNER, Material.MAGENTA_BANNER, Material.ORANGE_BANNER, Material.PINK_BANNER, Material.PURPLE_BANNER, Material.RED_BANNER, Material.WHITE_BANNER, Material.YELLOW_BANNER);
	...
	public static Inventory AlphabetInv(DyeColor Letter, DyeColor Background) {
		...
		List<Pattern> apatterns = new ArrayList<Pattern>();
		...
		am.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		a.setItemMeta(am);
		...
		List<Pattern> bpatterns = new ArrayList<Pattern>();
		...
		bm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		b.setItemMeta(bm);
		...
		cm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		c.setItemMeta(cm);
		...
		List<Pattern> dpatterns = new ArrayList<Pattern>();
		...
		dm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		d.setItemMeta(dm);
		...
		List<Pattern> epatterns = new ArrayList<Pattern>();
		...
		em.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		e.setItemMeta(em);
		...
		List<Pattern> fpatterns = new ArrayList<Pattern>();
		...
		fm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		f.setItemMeta(fm);
		...
		List<Pattern> gpatterns = new ArrayList<Pattern>();
		...
		gm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		g.setItemMeta(gm);
		...
		List<Pattern> hpatterns = new ArrayList<Pattern>();
		...
		hm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		h.setItemMeta(hm);
		...
		List<Pattern> ipatterns = new ArrayList<Pattern>();
		...
		im.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		i.setItemMeta(im);
		...
		List<Pattern> jpatterns = new ArrayList<Pattern>();
		...
		jm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		j.setItemMeta(jm);
		...
		List<Pattern> kpatterns = new ArrayList<Pattern>();
		...
		km.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		k.setItemMeta(km);
		...
		List<Pattern> lpatterns = new ArrayList<Pattern>();
		...
		lm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		l.setItemMeta(lm);
		...
		List<Pattern> mpatterns = new ArrayList<Pattern>();
		...
		mm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		m.setItemMeta(mm);
		...
		List<Pattern> npatterns = new ArrayList<Pattern>();
		...
		nm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		n.setItemMeta(nm);
		...
		List<Pattern> opatterns = new ArrayList<Pattern>();
		...
		om.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		o.setItemMeta(om);
		...
		List<Pattern> ppatterns = new ArrayList<Pattern>();
		...
		pm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		p.setItemMeta(pm);
		...
		List<Pattern> qpatterns = new ArrayList<Pattern>();
		...
		qm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		q.setItemMeta(qm);
		...
		List<Pattern> rpatterns = new ArrayList<Pattern>();
		...
		rm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		r.setItemMeta(rm);
		...
		List<Pattern> spatterns = new ArrayList<Pattern>();
		...
		sm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		s.setItemMeta(sm);
		...
		List<Pattern> tpatterns = new ArrayList<Pattern>();
		...
		tm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		t.setItemMeta(tm);
		...
		List<Pattern> upatterns = new ArrayList<Pattern>();
		...
		um.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		u.setItemMeta(um);
		...
		List<Pattern> vpatterns = new ArrayList<Pattern>();
		...
		vm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		v.setItemMeta(vm);
		...
		List<Pattern> wpatterns = new ArrayList<Pattern>();
		...
		wm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		w.setItemMeta(wm);
		...
		List<Pattern> xpatterns = new ArrayList<Pattern>();
		...
		xm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		x.setItemMeta(xm);
		...
		List<Pattern> ypatterns = new ArrayList<Pattern>();
		...
		ym.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		y.setItemMeta(ym);
		...
		List<Pattern> zpatterns = new ArrayList<Pattern>();
		...
		zm.setLore(Arrays.asList("§7Buchstabenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z.setItemMeta(zm);
		...
		List<Pattern> z0patterns = new ArrayList<Pattern>();
		...
		z0m.setLore(Arrays.asList("§7Zahlenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z0.setItemMeta(z0m);
		...
		List<Pattern> z1patterns = new ArrayList<Pattern>();
		...
		z1m.setLore(Arrays.asList("§7Zahlenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z1.setItemMeta(z1m);
		...
		List<Pattern> z2patterns = new ArrayList<Pattern>();
		...
		z2m.setLore(Arrays.asList("§7Zahlenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z2.setItemMeta(z2m);
		...
		List<Pattern> z3patterns = new ArrayList<Pattern>();
		...
		z3m.setLore(Arrays.asList("§7Zahlenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z3.setItemMeta(z3m);
		...
		List<Pattern> z4patterns = new ArrayList<Pattern>();
		...
		z4m.setLore(Arrays.asList("§7Zahlenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z4.setItemMeta(z4m);
		...
		List<Pattern> z5patterns = new ArrayList<Pattern>();
		...
		z5m.setLore(Arrays.asList("§7Zahlenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z5.setItemMeta(z5m);
		...
		List<Pattern> z6patterns = new ArrayList<Pattern>();
		...
		z6m.setLore(Arrays.asList("§7Zahlenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z6.setItemMeta(z6m);
		...
		List<Pattern> z7patterns = new ArrayList<Pattern>();
		...
		z7m.setLore(Arrays.asList("§7Zahlenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z7.setItemMeta(z7m);
		...
		List<Pattern> z8patterns = new ArrayList<Pattern>();
		...
		z8m.setLore(Arrays.asList("§7Zahlenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z8.setItemMeta(z8m);
		...
		List<Pattern> z9patterns = new ArrayList<Pattern>();
		...
		z9m.setLore(Arrays.asList("§7Zahlenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		z9.setItemMeta(z9m);

		ItemStack zminus = new ItemStack(BaseColorInfo.getBaseColorFromDyeColor(Background).getMaterial());
		BannerMeta zminusm = (BannerMeta) zminus.getItemMeta();
		List<Pattern> zminuspatterns = new ArrayList<Pattern>();
		...
		zminusm.setLore(Arrays.asList("§7Zeichenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
		zminus.setItemMeta(zminusm);

		ItemStack zexcla = new ItemStack(BaseColorInfo.getBaseColorFromDyeColor(Background).getMaterial());
		BannerMeta zexclam = (BannerMeta) zexcla.getItemMeta();
		List<Pattern> zexclapatterns = new ArrayList<Pattern>();
		...
		zexclam.setLore(Arrays.asList("§7Zeichenfarbe wählen: §aShift Linksklick", "§7Hintergrundfarbe wählen: §aShift Rechtsklick"));
	...
	public static Inventory CategoryBanner(String category, int page) {
		...
		if (page != 1) {
			ItemStack pi = new ItemStack(Material.ROSE_RED);
