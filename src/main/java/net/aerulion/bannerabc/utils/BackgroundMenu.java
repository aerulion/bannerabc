...
public class BackgroundMenu extends Menu {
  ...
  public BackgroundMenu(final @NotNull String name, final int size) {
    super(name, size);
  }
    ...
    if (item.hasItemMeta()) {
      if (item.getItemMeta().hasDisplayName()) {
        ...
        if (m.equals("§7§l§oSchwarz")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.BLACK);
        ...
        if (m.equals("§7§l§oRot")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.RED);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oGrün")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.GREEN);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oBraun")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.BROWN);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oBlau")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.BLUE);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oViolett")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.PURPLE);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oTürkis")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.CYAN);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oHellgrau")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.LIGHT_GRAY);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oGrau")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.GRAY);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oRosa")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.PINK);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oHellgrün")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.LIME);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oGelb")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.YELLOW);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oHellblau")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.LIGHT_BLUE);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oMagenta")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.MAGENTA);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
        if (m.equals("§7§l§oOrange")) {
          Utils.BACKGROUND_COLORS.put(p.getUniqueId(), DyeColor.ORANGE);
          p.openInventory(Utils.alphabetInv(Utils.LETTER_COLORS.get(p.getUniqueId()),
              Utils.BACKGROUND_COLORS.get(p.getUniqueId())));
        }
